...
class SendgridTransportTest extends TestCase
{
    ...
    public function testPayload()
    {
        ...
        $this->assertEquals([['email' => 'to@example.com', 'name' => 'To name']], $payload['to']);
        $this->assertEquals([['email' => 'cc@example.com', 'name' => 'CC name']], $payload['cc']);
        $this->assertEquals([['email' => 'bcc1@example.com', 'name' => 'BCC Name']], $payload['bcc']);
